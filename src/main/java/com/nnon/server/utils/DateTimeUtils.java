...
public class DateTimeUtils {
     ...
     * @return
     */
    public static String dateConvAppointStr(Date date) throws ParseException {
        if(date==null){
            return "";
        }
        ...
        if(dateStr.equals(nowDateStr)){
            long  l= betweenHour(new Date(), date);
            if(l==0){
                return "刚刚";
            }else{
                return l+"小时前";
    ...
    public static long betweenHour(Date d1,Date d2) throws ParseException {
